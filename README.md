...
Extracted from the sleepcast.pro repository on 2026-07-30. History was not
carried over — the source repo is private and its history contains the site's
marketing and legal copy plus 113MB of removed audio, none of which belongs
here. The code is the same code.

Not included, because they are the website rather than the player: the landing
page, colophon, legal pages, and the aggregate no-PII traffic counters.
